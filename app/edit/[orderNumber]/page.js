        ...
        <div className="mr-5 lg:ml-2 mt-10">
            ...
            <div className="px-5 lg:mt-1 md:mt-10 mt-48 lg:ml-0 md:-ml-1 ml-0 lg:text-sm md:text-sm text-xs sm:ml-2">
              <div className="py-1 rounded-md shadow-md bg-white lg:mt-2 ">
                ...
                <div className="px-5 text-left text-sm  text-gray-500 font-sans font-semibold -ml-1">
            ...
            <div className="flex px-5 mt-2 justify-between">
              ...
              <div className=" sm:w-auto mb-2 sm:mb-0 sm:mr-2 ">
                <div
                  className="px-3 py-2 rounded-md text-center bg-blue-600 hover:bg-blue-500 text-white font-bold cursor-pointer text-xs"
          ...
          {isMobile && (
            <div className=" absolute right-0 top-0 w-80 mt-8 bg-white rounded-md">
              ...
              <div className="mt-1 flex justify-start px-5">
                <input
                  ref={searchInputRef}
                  type="text"
                 ...
                 text-xs -ml-3 lg:ml-0 md:ml-0 lg:text-sm md:text-sm"
                />
              </div>
          ...
          <div className=" w-full lg:w-3/5 xl:shadow-lg md:w-96 hidden md:block bg-white mt-1">
            {/* <!-- header --> */}
            ...
            <div className="mt-2 flex justify-start px-5 -ml-2">
              <input
                ref={searchInputRef}
                type="text"
                placeholder="Search Menu / Id..."
            ...
            <div className="cursor-pointer grid grid-cols-2 bg-white md:grid-cols-3 lg:grid-cols-4 gap-3 lg:px-3 md:px-2 px-2 mt-2 custom-sidescrollbars overflow-scroll lg:max-h-[calc(90vh-1rem)] md:max-h-[calc(55vh-1rem)] max-h-[calc(97vh-1rem)] sm:max-h-[calc(80vh-1rem)]"
