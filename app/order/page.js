...
<script>
  ...
  const handleShiftTables = async (sectionId, destinationTableName, sourceTableName) => {
    try {
      // Perform a lookup in the Table collection to retrieve tableId for destinationTableName
      const destinationTableResponse = await axios.get(`http://103.159.85.246:5000/api/table/table/bySectionAndName/${sectionId}/${destinationTableName}`);
      const destinationTableId = destinationTableResponse.data._id;
      ...
      // Call the mergeTables endpoint with the retrieved tableIds
      const response = await axios.patch('http://103.159.85.246:5000/api/order/shiftBills', {
        destinationTableId,
        sourceTableId,
      });
      console.log(response.data); // Handle response data as needed
        ...
        <div className="flex lg:flex-row shadow-lg">
          <div className="w-full lg:w-1/2 lg:-ml-10 bg-gray-200 -mt-3 md:w-96 relative  ">
            ...
            <div className="lg:flex">
              <div className="font-bold text-sm px-3 flex mt-2 whitespace-nowrap">
                <div className="mr-5 lg:ml-2 mt-2">
                  <FontAwesomeIcon
                    icon={faHouse}
                    onClick={home}
                ...
                <div className='mt-3'>Last Bills</div>
                <div className="mt-3 mb-1 lg:ml-2 float-right">
                  <input
                    type="text"
                ...
                <div className="md:hidden cursor-pointer mr-4 absolute right-0 mb-2 rounded-md"
                ...
                <div className=" grid grid-cols-4 lg:grid-cols-4 md:grid-cols-4 text-left ml-3 mt-1 lg:mt-2 mb-2">
                  <button
              ...
              <div>
                ...
                <div className="px-5 lg:mt-8 mt-2 lg:ml-0 md:-ml-1 ml-0 lg:text-sm md:text-sm text-xs sm:ml-2">
                  <div className="py-1 rounded-md shadow-md bg-white  ">
                    ...
                    <div className="px-5 text-left text-xs lg:text-sm text-gray-600 font-sans font-bold lg:-ml-1 -ml-2 -mt-1 lg:mt-0 ">
                ...
                <div className="w-full lg:ml-0">
                  <div className=" grid lg:grid-cols-3 md:grid-cols-3 grid-cols-2 mt-2 gap-2 pl-2 pr-2">
                    <div className="w-auto mb-0 lg:mb-2 sm:mr-2">
                      <div
                        className="px-2 mx-3 py-1.5 lg:py-2 text-center rounded-md bg-blue-700 hover:bg-blue-600 text-white font-bold cursor-pointer text-xs"
                        onClick={saveBill}
                      >
                        KOT ( / )
                      </div>
                    ...
                    <div className=" sm:w-auto mb-0 lg:mb-2  sm:mr-2">
                      <div
                        className="px-2 py-1.5 mx-3 lg:py-2 rounded-md text-center bg-red-600 hover:bg-red-500 text-white font-bold cursor-pointer text-xs"
                        onClick={saveKot}
                      >
                        Re-KOT ( . )
                      </div>
                    ...
                    <div className=" sm:w-auto mb-0 lg:mb-2 sm:mr-2 ">
                      <div
                        className="px-2 py-1.5 mx-3 lg:py-2 rounded-md text-center bg-green-600 hover:bg-green-500 text-white font-bold cursor-pointer text-xs"
                        onClick={WaitingBill}
                      >
                        Waiting (Home)
                      </div>
                    ...
                    <div className=" sm:w-auto mb-0 lg:mb-2 sm:mr-2 ">
                      <div
                        className="px-2 py-1.5 mx-3 lg:py-2 rounded-md text-center bg-violet-800 hover:bg-violet-700 text-white font-bold cursor-pointer text-xs"
                        onClick={handleSave}
                      >
                        Save-Bill (PgUp)
                      </div>
                    ...
                    <div className=" sm:w-auto mb-0 lg:mb-2 sm:mr-2 ">
                      <div
                        className="px-2 py-1.5 lg:py-2 mx-3 rounded-md text-center bg-orange-600 hover:bg-orange-500 text-white font-bold cursor-pointer text-xs"
                    ...
                    <div className=" sm:w-auto mb-0 lg:mb-2 sm:mr-2 ">
                      <div
                        className="px-3 py-1.5 lg:py-2 mx-3 rounded-md text-center bg-gray-600 hover:bg-gray-500 text-white font-bold cursor-pointer text-xs"
            ...
            {isShiftModalOpen && (
              <div className="fixed inset-0 flex items-center justify-center z-50" style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                <div className="modal-container bg-white w-full md:w-96 p-6 m-4 rounded shadow-lg text-sm md:text-base" onClick={(e) => e.stopPropagation()}>
                  <button type="button" className="bg-red-100 text-red-600 p-1 px-2 hover:bg-red-200 rounded-full text-center float-right" onClick={() => setIsShiftModalOpen(false)}>
                    <FontAwesomeIcon icon={faTimes} size="lg" />
                  </button>
                  <div className="p-1 text-sm md:text-base">
                    <h3 className="mb-5 text-lg font-semibold text-gray-800 dark:text-gray-400 text-center">Shift Table</h3>
                    <div className="mb-4">
                      <label htmlFor="destinationTableId" className="block text-sm font-medium text-gray-700 dark:text-gray-400">
                        To Table
                      </label>
                    ...
                    <div className="text-center text-sm md:text-base">
                      <button
                        type="button"
                        className="bg-orange-100 hover:bg-orange-200 text-orange-600 font-bold py-2 px-4 rounded-full w-72 mx-auto mt-4"
                        onClick={() => handleShiftTables(sectionId, destinationTableId, sourceTableId)}
                      >
                        Shift
                      </button>
                    </div>
          ...
          <div className=" w-56 lg:w-3/5 md:w-96 lg:pl-3 hidden md:block bg-white ">
            ...
            <div className=" flex flex-row px-2 ml-1 custom-scrollbars overflow-x-auto whitespace-nowrap">
              <span
                key="all-items"
                className={`cursor-pointer px-2 bg-orange-100 py-1 mb-1 rounded-xl text-xs lg:text-sm font-semibold mr-4 ${selectedCategory === null ? "bg-yellow-500 text-white" : ""
                  }`}
                onClick={() => handleCategoryClick(null)}
              >
                All Menu
              ...
              {categories.map((category) => (
                <span
                  key={category._id}
                  className={`whitespace-nowrap bg-orange-100 cursor-pointer px-5 ml-3 py-1 mb-1 rounded-xl lg:text-sm md:text-sm text-xs sm:text-xs font-semibold ${selectedCategory === category
                    ? "bg-yellow-500 text-white"
                    : ""
                    }`}
                  onClick={() => handleCategoryClick(category)}
